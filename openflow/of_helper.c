...
#define PREREQ_INVALID 1U<<0
#define PREREQ_VLAN 1U<<1
#define PREREQ_IPV4 1U<<2
#define PREREQ_IPV6 1U<<3
#define PREREQ_ARP 1U<<4
#define PREREQ_TCP 1U<<5
#define PREREQ_UDP 1U<<6
#define PREREQ_SCTP 1U<<7
#define PREREQ_ICMPV4 1U<<8
#define PREREQ_ICMPV6 1U<<9
#define PREREQ_ND_SLL 1U<<10
#define PREREQ_ND_TLL 1U<<11
#define PREREQ_MPLS 1U<<12
#define PREREQ_PBB 1U<<13
